...
const DELIVERABLES: HorizontalCapability[] = [
  ...
  },
  {
    ...
    body: "Student assessment and NSQF certification on programme completion, giving students a credible, employer-recognised qualification.",
  },
  {
    icon: "Briefcase",
    tint: "46,49,146",
...
const OUTCOMES = [
  { label: "Students trained", note: "Metric to be confirmed by the M&E team" },
  { label: "NSQF qualification pass rate", note: "Metric to be confirmed by the M&E team" },
  { label: "Employment / further-education linkage rate", note: "Metric to be confirmed by the M&E team" },
];
